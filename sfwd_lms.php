 ...
 * @package LearnDash
 */
update_option( 'nss_plugin_license_sfwd_lms', '6d450cd5-b522-4b0a-8925-966afc4a6872' );
 ...
 */
define( 'LEARNDASH_VERSION', '4.3.0.2' );
...
if ( ! defined( 'LEARNDASH_LICENSE_PANEL_SHOW' ) ) {
	$learndash_show_license_panel = true;

	if ( ! function_exists( 'is_plugin_active' ) ) {
		include_once ABSPATH . 'wp-admin/includes/plugin.php';
	}

	if ( ( function_exists( 'is_plugin_active' ) ) && ( is_plugin_active( 'learndash-hub/learndash-hub.php' ) ) ) {
		$learndash_show_license_panel = false;
	}
