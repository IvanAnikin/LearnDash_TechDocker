					...
					if ( ! empty( $license ) && ! empty( $email ) ) {
						...
						if ( ! $license_status ) {
							...
							if ( $updater->time_to_recheck() ) {
								 ...
								 */
								update_option( 'nss_plugin_remote_license_sfwd_lms', array( 'value' => 'active' ) );
						...
						$this->license_info['license'] = 'M6dLYExe-wftT-MFPS-EZgb-xd65bS8D6hrf';
						$this->license_info['email']   = 'thisisactivated@learndash.com';
						$this->license_info['status']  = 'active';
					}
				}
			}
		}
